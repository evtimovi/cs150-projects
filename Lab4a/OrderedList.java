 ...
 * Therefore, the methods that provide common functionality for the child classes
 * work with parameters, allowing the instance variable of the child
 * to be modified by passing it as a parameter to the parent's method.
 * 
 * @author Ivan Evtimov
 * 
 */
