...
public class Database{
   ...
   * @throws IllegalStateException if the input database was wrong
   */
  public void createDatabaseFromFile( String inputFilePath ) throws IllegalStateException{
   ...
   //   System.out.println("database 124: restaurants added: " + debuggerCounter);
      ...
      //throw it up the execution stack because it will be used to terminate the program
      throw e;
    }
    finally {
      //close the scanner 
