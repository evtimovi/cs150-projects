...
public class Restaurant implements Comparable<Restaurant>{
   ...
   * @throw IllegalStateException if there is something wrong with the input file
   */
  public Restaurant ( String restaurantBlock ) throws IllegalStateException{
    ...
    try{
      ...
      //let the exception propagate up the stack
      throw new IllegalStateException("No Match found for: " + name + " details: " + e);
    }
  }
 ...
 /**
  ...
  private void setRank( double newRank ) throws IllegalArgumentException{
    ...
    if( newRank < 0.0 || newRank > 5.0 ){
      throw new IllegalArgumentException("Rank must be between 0 and 5" + name );
