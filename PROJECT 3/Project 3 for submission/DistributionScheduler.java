...
public class DistributionScheduler{
  ...
  public void printReport(){
    ...
    System.out.println("all stores: " + gc.getAllStoresArr().size());
    allStoresArr.removeAll( processedStoresArr );
    
    System.out.println(allStoresArr);
    System.out.println("unprocessed Stores count: " + allStoresArr.size() );
...
//    
    ...
    System.out.println("!!!!!!!!!!!!! Total run time in milliseconds: " + totalTime);
  }
}